            ...
            <main id="content-column">
                <div class="editable-zone" data-id="mainContent">
                    ...
                    <div data-type="block" data-id="556" data-name="Emakina_Website_Banner" data-layout-emakina-website-banner="" data-rbs-block-container="556" class="block visible-lg-block visible-md-block visible-sm-block">
                        ...
                        <div class="banner center bottom dark" style="height: 380px; background-image: url(' {{ asset('frontend/Assets/Imagestorage/images/2560/1600/65c0b7d8ef1ef_UK_Slider_principal_Nouvelle_Co_Mobile.gif') }}'); ">
                    ...
                    {{--@foreach($product_all as $pro_item)--}}
  ...
  height: 310px;
  background-image: url(' {{ asset('/uploads/'.$settings[0]->banner) }}'); ">
                            <div class=" banner__container">
                                <div class="container">
                                    <div class="banner__content">
                                        <div class="banner__cta-container flex-display flex-wrap">
                    ...
                    <div class="row full-wrapper with-small-margin" data-id="631" data-grid="12">
                        ...
                        <div class="col-md-4" data-id="628" style="padding: 20px" >
                            ...
                            <div data-type="block" data-id="634" data-name="Emakina_Website_Banner" data-layout-emakina-website-banner="" data-rbs-block-container="634" class="block visible-sm-block visible-md-block visible-lg-block">
                                ...
                                <div class="banner center middle dark" style="height: 600px; background-image: url({{ asset('/uploads/' . $pro_item->gallery_img)}});">
                                    <div class="banner__container">
                                        <div class="container">
                                            <div class="banner__content">
                            ...
                            <div data-type="block" data-id="640" data-name="Emakina_Website_Banner" data-layout-emakina-website-banner="" data-rbs-block-container="640" class="block visible-xs-block">
                                ...
                                <div class="banner center bottom dark" style="height: 310px; background-image: url({{ asset('/uploads/' . $pro_item->gallery_img) }});" >
                                    <div class="banner__container">
                                        <div class="container">
                                            <div class="banner__content">
                        ...
                        {{--<div class="col-md-4" data-id="629">
                            <div data-type="block" data-id="635" data-name="Emakina_Website_Banner" data-layout-emakina-website-banner="" data-rbs-block-container="635" class="block with-small-margin-mobile visible-sm-block visible-md-block visible-lg-block">
                                ...
                                <div class="banner center middle dark" style="height: 600px; background-image: url(' {{ asset('frontend/Assets/Imagestorage/images/2560/1600/65dc500a90cdd_produits_desktop_mariniere_680px_2.jpg') }}'); ">
                                    <div class=" banner__container">
                                        <div class="container">
                                            <div class="banner__content">
                            ...
                            <div data-type="block" data-id="641" data-name="Emakina_Website_Banner" data-layout-emakina-website-banner="" data-rbs-block-container="641" class="block with-small-margin-mobile visible-xs-block">
                                ...
                                <div class="banner center bottom dark" style="height: 310px; background-image: url(' {{ asset('frontend/Assets/Imagestorage/images/2560/1600/65dc5255a499d_produits_mobile_mariniere_310px_2.jpg') }}'); ">
                                    <div class=" banner__container">
                                        <div class="container">
                                            <div class="banner__content">
                                                <h2 class="banner__title">Breton striped shirt</h2>
                        ...
                        {{--<div class="col-md-4" data-id="632">
                            <div data-type="block" data-id="636" data-name="Emakina_Website_Banner" data-layout-emakina-website-banner="" data-rbs-block-container="636" class="block with-small-margin-mobile visible-sm-block visible-md-block visible-lg-block">
                                ...
                                <div class="banner center middle dark" style="height: 600px; background-image: url(' {{ asset('frontend/Assets/Imagestorage/images/2560/1600/65dc50e8676e5_produits_desktop_veste_680px_3.jpg') }}'); ">
                                    <div class=" banner__container">
                                        <div class="container">
                                            <div class="banner__content">
                            ...
                            <div data-type="block" data-id="642" data-name="Emakina_Website_Banner" data-layout-emakina-website-banner="" data-rbs-block-container="642" class="block with-small-margin-mobile visible-xs-block">
                                ...
                                <div class="banner center bottom dark" style="height: 310px; background-image: url(' {{ asset('frontend/Assets/Imagestorage/images/2560/1600/65dc52e563983_produits_mobile_veste_310px_2.jpg') }}'); ">
                                    <div class=" banner__container">
                                        <div class="container">
                                            <div class="banner__content">
                                                <h2 class="banner__title">Jacket</h2>
                    ...
                    <div data-type="block" data-id="620" data-name="Emakina_Website_Banner" data-layout-emakina-website-banner="" data-rbs-block-container="620" class="block container with-small-margin visible-sm-block visible-md-block visible-lg-block">
                        ...
                        <div class="banner center bottom dark" style="height: 400px; background-image: url({{asset('uploads/'.$product_all[0]->featured_img)}}); ">
                            <div class=" banner__container">
                                <div class="container">
                                    <div class="banner__content">
                                        <div class="banner__cta-container flex-display flex-wrap">
                    ...
                    <div data-type="block" data-id="626" data-name="Emakina_Website_Banner" data-layout-emakina-website-banner="" data-rbs-block-container="626" class="block container with-small-margin visible-xs-block">
                        ...
                        <div class="banner center bottom dark" style="
    height: 350px;
    background-image: url({{asset('uploads/'.$product_all[0]->featured_img)}});">
                            <div class=" banner__container">
                                <div class="container">
                                    <div class="banner__content">
                                        <div class="banner__cta-container flex-display flex-wrap">
